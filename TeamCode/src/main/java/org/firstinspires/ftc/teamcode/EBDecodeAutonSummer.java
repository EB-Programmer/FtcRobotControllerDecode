...
public class EBDecodeAutonSummer extends LinearOpMode {
    ...
    private static final double SHOOTER_HIGH_VELOCITY = 1550;
    private static final double SHOOTER_LOW_VELOCITY = 1200;
    ...
    /// drive is in the range -1 to 1
    /// strafe is in the range -1 to 1
    /// turn is in the range -1 to 1
    /// powerLimit is in the range 0 to 1
    public void drive(double drive, double strafe, double turn, double powerLimit) {
        ...
        leftDriveBack.setPower(rearLeftPower);
        rightDriveBack.setPower(rearRightPower);
    }
